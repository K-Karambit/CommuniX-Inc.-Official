...
<head>
    ...
    <link rel="stylesheet" href="../css/AnnouncementAndEvents.css">

    <title>CommuniX Inc.</title>
</head>

<body oncontextmenu="return false" onload="check()">
<style><?php include "../css/AnnouncementAndEvents.css" ?></style>
    <div class="container">
                        ...
                        <ul class="nav-ul">
                            ...
                            <li class="nav-li nav-li-careers">
                                ...
                                <div class="dropdown-careers-content">
                                    <a href="#" class="dropdown-careers-content-a nav-a-AnnouncementAndEvents">Announcement and Events</a>
        ...
        <div class="hero-container">
            <div class="hero-text-container">
                <h1 class="hero-h1">Announcement and Events</h1>
            </div>
        </div>
    ...
    <script src="../js/AnnouncementAndEvents.js"></script>
