...
<body oncontextmenu="return false">
    <style>
        <?php include "../css/EmployeeDashboard.css" ?>
    </style>
    <div class="container">
            ...
            <nav>
                <div class="nav-contents">
                    ...
                    <div class="nav-links">
                        <ul class="nav-ul">
                            <li class="nav-li">
                                <a id=avatar-img-a onclick="DropdownClick()"><img src="../img/ASSETS/AVATAR4.jpg" alt="AVATAR" class="avatar-img"></a>
                            </li>
                        </ul>
                        <ul class=nav-ul id=Dropdown onmouseleave="NoDropdown()"">
                            <li class=DropdownList-li><a class=DropdownList-a href=" #">Profile</a></li>
                            <li class=DropdownList-li><a class=DropdownList-a onclick="EmployeeLogout()">Logout</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="announcement-and-events-cards-container">
                            ...
                            <div class="announcement-and-events-card">
                                <div class="announcement-and-events-img-header">
                                    <img src="../img/ASSETS/CoachingTools_BG.jpg" alt="SAMPLE BG" class="announcement-and-events-img">
                                </div>

                                <div class="announcement-and-events-description">
                                    <h1 class="announcement-event-title-h1">How strategic thinking works</h1>
                            ...
                            <div class="announcement-and-events-card">
                                ...
                                <div class="announcement-and-events-description">
                                    <h1 class="announcement-event-title-h1">Implementing Waterfall Method</h1>
                                    <h3 class="supporting-details-h3">Bacoor, Philippines</h3>
                                    <p class="announcement-and-events-description-p">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum iure dignissimos laborum, velit fugit quisquam.
                                    </p>
                            ...
                            <div class="announcement-and-events-card">
                                ...
                                <div class="announcement-and-events-description">
                                    <h1 class="announcement-event-title-h1">Artificial Intelligence</h1>
                                    <h3 class="supporting-details-h3">Bacoor, Philippines</h3>
                                    <p class="announcement-and-events-description-p">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum iure dignissimos laborum, velit fugit quisquam.
                                    </p>
                            ...
                            <div class="announcement-and-events-card">
                                ...
                                <div class="announcement-and-events-description">
                                    <h1 class="announcement-event-title-h1">How Alphabet Work Volume 1</h1>
                                    <h3 class="supporting-details-h3">Bacoor, Philippines</h3>
                                    <p class="announcement-and-events-description-p">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum iure dignissimos laborum, velit fugit quisquam.
                                    </p>
                            ...
                            <div class="announcement-and-events-card">
                                ...
                                <div class="announcement-and-events-description">
                                    <h1 class="announcement-event-title-h1">How Alphabet Work Volume 2</h1>
                                    <h3 class="supporting-details-h3">Bacoor, Philippines</h3>
                                    <p class="announcement-and-events-description-p">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum iure dignissimos laborum, velit fugit quisquam.
                                    </p>
                            ...
                            <div class="announcement-and-events-card">
                                ...
                                <div class="announcement-and-events-description">
                                    <h1 class="announcement-event-title-h1">How Alphabet Work Volume 3</h1>
                                    <h3 class="supporting-details-h3">Bacoor, Philippines</h3>
                                    <p class="announcement-and-events-description-p">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum iure dignissimos laborum, velit fugit quisquam.
                                    </p>
