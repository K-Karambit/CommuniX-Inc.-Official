...
<head>
    ...
    <link rel="stylesheet" href="../../css/HumanResourceDashboard.css">
...
<body oncontextmenu="return false">
    <style>
        <?php include "../../css/HumanResourceDashboard.css" ?>
    </style>
    <div class="container">
            ...
            <nav>
                <div class="nav-contents">
                    ...
                    <div class="nav-links">
                        <ul class="nav-ul">
                            <li class="nav-li">
                                <a id=avatar-img-a onclick="DropdownClick()"><img src=" ../../img/ASSETS/AVATAR3.jpg" alt="AVATAR" class="avatar-img"></a>
                            </li>
                        </ul>
                        <ul class=nav-ul id=Dropdown onmouseleave="NoDropdown()"">
                            <li class=DropdownList-li><a class=DropdownList-a href=" #">Profile</a></li>
                            <li class=DropdownList-li><a class=DropdownList-a onclick="HumanResourceLogout()">Logout</a></li>
                        </ul>
                    </div>
                ...
                <div class="history-form-container">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>Logged In: Thursday / 2022 / 10 / 20 - 4:06am</td>
                            <td><a href="../Accounts/Download/">Download Account History</a></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Keanu Gaerlan</td>
                            <td>Gaerlan123@gmail.com</td>
                            <td>Last Signed In: January 10, 2004</td>
                            <td><a href="../Accounts/Download/">Download Account History</a></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            ...
                            <td>Logged In: Thursday / 2022 / 10 / 20 - 4:20am</td>
                            <td><a href="../Accounts/Download/">Download Account History</a></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            ...
                            <td>Last Signed In: October 12, 2022</td>
                            <td><a href="../Accounts/Download/">Download Account History</a></td>
                        </tr>
                    </table>
    ...
    <script src="../../js/HumanResource.js"></script>
